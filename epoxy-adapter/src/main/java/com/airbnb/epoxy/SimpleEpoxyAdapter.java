...
/**
 * A non-abstract version of {@link com.airbnb.epoxy.EpoxyAdapter} with public methods. Use this if
 * you don't want to create your own adapter subclass and instead want to modify the adapter from
 * elsewhere.
 */
