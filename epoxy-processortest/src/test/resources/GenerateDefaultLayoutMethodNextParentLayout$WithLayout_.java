...
public class GenerateDefaultLayoutMethodNextParentLayout$WithLayout_ extends GenerateDefaultLayoutMethodNextParentLayout.WithLayout implements GeneratedModel<Object> {
  ...
  @Override
  public GenerateDefaultLayoutMethodNextParentLayout$WithLayout_ id(Number... ids) {
    super.id(ids);
    return this;
  }
  ...
  @Override
  public GenerateDefaultLayoutMethodNextParentLayout$WithLayout_ id(CharSequence key) {
    super.id(key);
    return this;
  }

  @Override
  public GenerateDefaultLayoutMethodNextParentLayout$WithLayout_ id(CharSequence key, long id) {
    super.id(key, id);
    return this;
  }
  ...
  @Override
  public GenerateDefaultLayoutMethodNextParentLayout$WithLayout_ spanSizeCallback(@Nullable EpoxyModel.SpanSizeCallback arg0) {
