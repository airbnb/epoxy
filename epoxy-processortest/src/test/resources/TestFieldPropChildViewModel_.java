...
public class TestFieldPropChildViewModel_ extends EpoxyModel<TestFieldPropChildView> implements GeneratedModel<TestFieldPropChildView>, TestFieldPropChildViewModelBuilder {
  ...
  @Override
  public TestFieldPropChildViewModel_ id(Number... ids) {
    super.id(ids);
    return this;
  }
  ...
  @Override
  public TestFieldPropChildViewModel_ id(CharSequence key) {
    super.id(key);
    return this;
  }

  @Override
  public TestFieldPropChildViewModel_ id(CharSequence key, CharSequence... otherKeys) {
    super.id(key, otherKeys);
    return this;
  }

  @Override
  public TestFieldPropChildViewModel_ id(CharSequence key, long id) {
    super.id(key, id);
    return this;
  }
