...
public class ModelForRProcessingTest_ extends ModelForRProcessingTest implements GeneratedModel<Object> {
  ...
  @Override
  public ModelForRProcessingTest_ id(Number... ids) {
    super.id(ids);
    return this;
  }
  ...
  @Override
  public ModelForRProcessingTest_ spanSizeCallback(@Nullable EpoxyModel.SpanSizeCallback arg0) {
